...
export default function App() {
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-bg-tertiary flex items-center justify-center p-4 bg-[radial-gradient(circle_at_top_right,_var(--tw-colors-bg-secondary)_0%,_transparent_40%)]">
        <motion.div 
        ...
        >
          <div className="text-center mb-8">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#185FA5]/10 text-[#185FA5] mb-4 shadow-inner">
              <Scale size={32} />
            </div>
            <h1 className="text-3xl font-bold text-text-primary tracking-tight">{appName}</h1>
            <p className="text-text-secondary mt-2">Sistem Akuntansi Terintegrasi Google Sheets</p>
          </div>

          <div className="bg-bg-primary border border-border-tertiary rounded-2xl p-8 shadow-xl shadow-slate-200/50">
            {/* Google Login - Primary Method */}
            <div className="space-y-4 mb-8">
              <h3 className="text-sm font-bold text-text-primary mb-4 text-center">Masuk dengan Akun Google</h3>
              <button
                onClick={handleGoogleLink}
                className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 border border-gray-200 py-3.5 rounded-xl font-bold hover:bg-gray-50 transition-all shadow-sm active:scale-[0.98]"
              >
              ...
              <p className="text-[10px] text-text-secondary text-center leading-relaxed">
                Rekomendasi Utama: Akun Google diperlukan untuk menyimpan data secara otomatis dan permanen di Google Sheets Anda.
              </p>
            </div>

            <div className="relative mb-8">
              <div className="absolute inset-0 flex items-center"><div className="w-full border-t border-border-tertiary"></div></div>
              <div className="relative flex justify-center text-[10px] uppercase font-bold"><span className="bg-bg-primary px-3 text-text-secondary tracking-widest">Atau Manual</span></div>
            </div>

            {/* Email Form - Secondary Method */}
            <form onSubmit={handleEmailAuth} className="space-y-4">
              <div className="space-y-1.5">
                <label className="text-[11px] font-bold text-text-secondary uppercase ml-1">Email</label>
                <div className="relative">
                  ...
                  <input 
                    ...
                    className="w-full pl-11 pr-4 py-3 bg-bg-secondary border border-border-tertiary rounded-xl focus:ring-2 focus:ring-[#185FA5]/10 focus:border-[#185FA5] outline-none transition-all font-medium"
                    required
                  />
                </div>
              </div>
              <div className="space-y-1.5">
                <label className="text-[11px] font-bold text-text-secondary uppercase ml-1">Password</label>
                <div className="relative">
                  ...
                  <input 
                    ...
                    placeholder="••••••••"
                    className="w-full pl-11 pr-4 py-3 bg-bg-secondary border border-border-tertiary rounded-xl focus:ring-2 focus:ring-[#185FA5]/10 focus:border-[#185FA5] outline-none transition-all"
                    required
                  />
                </div>
              </div>
              ...
              <button 
                type="submit"
                disabled={isLoading}
                className="w-full py-3.5 bg-text-primary text-bg-primary rounded-xl font-bold hover:opacity-90 transition-all shadow-lg active:scale-[0.98] disabled:opacity-50"
              >
                {isLoading ? <Loader2 className="w-5 h-5 animate-spin mx-auto" /> : loginMode === "SIGN_IN" ? "Masuk" : "Daftar Akun"}
              </button>
              ...
              <div className="flex items-center justify-between px-1 pt-1">
                <button 
                  ...
                  className="text-xs text-[#185FA5] font-bold hover:underline"
                >
                  {loginMode === "SIGN_IN" ? "Buat akun baru" : "Sudah punya akun?"}
                </button>
                {loginMode === "SIGN_IN" && (
                  <button 
                    type="button" 
            ...
            <div className="mt-10 pt-6 border-t border-border-tertiary text-center">
              <button 
                type="button"
                onClick={() => {
                ...
                className="text-xs text-text-secondary hover:text-text-primary transition-all font-bold uppercase tracking-widest flex items-center justify-center gap-2 mx-auto"
              >
                <ChevronRight size={14} /> Masuk Tanpa Akun (Mode Demo)
              </button>
            </div>
          </div>

          <p className="text-[10px] text-center text-text-secondary mt-8 uppercase tracking-[0.2em] font-medium opacity-60">
            Professional Cloud Accounting • v2.1
          </p>
        </motion.div>
      </div>
    );
